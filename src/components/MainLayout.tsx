      ...
      <header className={styles.header}>
        <nav className={styles.header__nav}>
          <ul className={styles.header__nav_list}>
            <li className={styles.header__nav_list_item}>
              <Link href="/">
                <a className={styles.header__nav_list_link}>
            ...
            <li className={styles.header__nav_list_item}>
              <Link href="/">
                ...
                `${styles.header__nav_list_link}`,
                { [`${styles.header__nav_list_link__active}`]: pathname === "/" }
              )}>
                  Home
                </a>
              </Link>
            ...
            <li className={styles.header__nav_list_item}>
              ...
              <a className={classNames(
                `${styles.header__nav_list_link}`,
                { [`${styles.header__nav_list_link__active}`]: pathname === "/phones" }
              )}>
                  Phones
                </a>
              </Link>
            ...
            <li className={styles.header__nav_list_item}>
              ...
              <a className={classNames(
                `${styles.header__nav_list_link}`,
                { [`${styles.header__nav_list_link__active}`]: pathname === "/tablets" }
              )}>
                  Tablets
                </a>
              </Link>
            ...
            <li className={styles.header__nav_list_item}>
              ...
              <a className={classNames(
                `${styles.header__nav_list_link}`,
                { [`${styles.header__nav_list_link__active}`]: pathname === "/accessories" }
              )}>
                  Accessories
                </a>
              </Link>
        ...
        <nav className={styles.header__nav}>
          ...
          <Link href="/favourites">
            <a className={classNames(
              `${styles.header__nav_list_link_button}`,
              { [`${styles.header__nav_list_link__active}`]: pathname === "/favourites" }
            )}>
